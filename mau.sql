...
/*!40101 SET character_set_client = @saved_cs_client */;
-- thêm bảng career_handbook_categories
...
-- Create career_handbook_categories table
...
-- Insert sample data
INSERT INTO `career_handbook_categories` VALUES 
('1', '1'),  -- "How to Choose the Right Career Path" in "Định hướng nghề nghiệp"
('2', '2'),  -- "Job Search Strategies That Work" in "Bí kíp tìm việc"
('3', '3'),  -- "Understanding Compensation Packages" in "Chế độ lương thưởng"
('4', '4'),  -- "Industry-Specific Knowledge: IT Sector" in "Kiến thức chuyên ngành"
('5', '5'),  -- "Preparing for Your First Job" in "Hành trang nghề nghiệp"
('6', '6'),  -- "Top Recruitment Trends in 2025" in "Thị trường và xu hướng tuyển dụng"
('7', '1'),  -- "How to Build Your Personal Brand" in "Định hướng nghề nghiệp"
('8', '2'),  -- "Networking Tips for Job Seekers" in "Bí kíp tìm việc"
('9', '3'),  -- "Navigating Remote Work Compensation" in "Chế độ lương thưởng"
('10', '6'), -- "Adapting to Changes in the Job Market" in "Thị trường và xu hướng tuyển dụng"
('11', '1'), -- Multiple categories for some posts
('11', '2'),
('12', '2'),
('13', '3'),
('14', '4'),
