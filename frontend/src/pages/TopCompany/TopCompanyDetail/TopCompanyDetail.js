...
//                 <div key={review.review_id} className={cx("review-item")}>
...
//                     <button
//                       key={index}
//                       className={cx("page-btn", { active: currentReviewPage === index + 1 })}
                  ...
                  {currentJobs.map((job, index) => (
                    ...
                    >
                      ...
                      <div className={cx("job-actions")}>
                        ...
                        <button 
                          className={cx("apply-btn", "primary-btn", { disabled: job?.status !== "Pending" })}
