...
import { FaBook, FaPlus, FaPen, FaTrash, FaCalendarAlt, FaUserEdit, FaEye } from "react-icons/fa";
...
function CareerHandbook() {
  ...
  const EditModal = ({ handbook, onClose }) => {
    ...
    const handleSubmit = async (e) => {
      e.preventDefault();
      try {
        await authAPI().patch(adminApis.updateCareerHandbook(handbook.post_id), formData);
                  ...
                  <tr key={handbook.post_id}>
                    ...
                    <td>
                      <div className={cx('actions')}>
                        ...
                        <button className={cx('action-btn', 'delete')} title="Xóa">
                          <FaTrash />
                        </button>
                      </div>
                    </td>
